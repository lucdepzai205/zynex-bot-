...
def key_prices_keyboard():
    kb = types.InlineKeyboardMarkup(row_width=1)
    kb.add(types.InlineKeyboardButton("1️⃣ Key 3 Ngày — 50k", callback_data="buy_3ngay"))
    kb.add(types.InlineKeyboardButton("2️⃣ Key 1 Tuần — 80k", callback_data="buy_1tuan"))
    kb.add(types.InlineKeyboardButton("3️⃣ Key 1 Tháng — 150k", callback_data="buy_1thang"))
    kb.add(types.InlineKeyboardButton("4️⃣ Key Vĩnh Viễn — 200k", callback_data="buy_vip"))
